...
class __TwigTemplate_f0ed4248156c810e4cb9e9b8973cdd20 extends Template
{
    private $source;
    private $macros = [];
    ...
    <figure class=\"jag\"><img src=\"";
        // line 9
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("build/images/random/{{ number }}.jpg"), "html", null, true);
        echo "\" alt=\"jag\"></figure>
";
        // line 10
        $this->loadTemplate("footer.html.twig", "lucky_number.html.twig", 10)->display($context);
...
{% block body %}
    ...
    <figure class=\"jag\"><img src=\"{{ asset('build/images/random/{{ number }}.jpg') }}\" alt=\"jag\"></figure>
{% include \"footer.html.twig\" %}
{% endblock %}
", "lucky_number.html.twig", "/home/adam/dbwebb-kurser/mvc/me/report/symfony/app/templates/lucky_number.html.twig");
    }
}
