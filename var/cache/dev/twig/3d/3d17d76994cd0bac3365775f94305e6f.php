...
<html>
    <head>
        ...
        // line 15
        echo "        <header class=\"site-header\" style=\"background-image: url(";
        ...
        echo ")\">
            <span class=\"site-title\">Min MVC hemsida</span>
            <nav class=\"nav\">
                <ul>
                    <li><a href=\"";
        // line 19
...
<html>
    <head>
        <meta charset=\"UTF-8\">
        <title>{% block title %}Välkommen!{% endblock %}</title>
        ...
        {% endblock %}
        <header class=\"site-header\" style=\"background-image: url({{ asset('img/header.png') }})\">
            <span class=\"site-title\">Min MVC hemsida</span>
            <nav class=\"nav\">
                <ul>
